...
// === Debug ===
//
// * Zeigt an ob Übersetzungen für Facettenausprägungen vorhanden sind.
ZIMT.DATA.DefaultValues.Debug = false;

// === Query Default Values ===
ZIMT.DATA.DefaultValues.qProtocol = document.location.protocol + "//";
ZIMT.DATA.DefaultValues.qHost = "gams.uni-graz.at/";
ZIMT.DATA.DefaultValues.qCore = "pardus/search/";
